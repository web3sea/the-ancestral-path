...
export default function ABJRecordingsLanding() {
  const router = useRouter();

  const handleAccessRecordings = () => {
    router.push("/abj-recordings/list");
  };

  return (
    <div
      className="pt-20 bg-black/70"
      style={{
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24">
        ...
        >
          ...
          <button
            onClick={handleAccessRecordings}
            className="group flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-primary-300/20 to-primary-300/10 text-primary-300 rounded-2xl hover:from-primary-300/30 hover:to-primary-300/20 transition-all duration-300 text-lg font-semibold border border-primary-300/20 hover:border-primary-300/40 hover:shadow-lg hover:shadow-primary-300/20 hover:scale-[1.02] active:scale-[0.98] mx-auto"
          >
